# agent-infra-data-bridge-resolver-edge-fas

## Detailed Description

agent-infra-data-bridge-resolver-edge-fas is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
